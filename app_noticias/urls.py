...
urlpatterns = [
    ...
    path('denuncias/', views.DenunciaNoticiaView.as_view(), name='denuncias_noticias'),
    path('denuncias/sucesso/', views.DenunciaNoticiaSucessoView.as_view(), name='denuncia_sucesso'),
]
